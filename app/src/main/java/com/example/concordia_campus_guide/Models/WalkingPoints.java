...
public class WalkingPoints {
        ...
        public WalkingPoints(){
            walkingPoints = new ArrayList<WalkingPoint>();
        }

        public List<WalkingPoint> getBuildings(){
            return walkingPoints;
        }


        public WalkingPoints(List<WalkingPoint> walkingPoints){
            this.walkingPoints = walkingPoints;
        }

        public void setWalkingPoints(List<WalkingPoint> walkingPoints){
            this.walkingPoints = walkingPoints;
        }
