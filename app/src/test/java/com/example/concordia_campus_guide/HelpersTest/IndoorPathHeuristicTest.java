...
public class IndoorPathHeuristicTest {
    ...
    public void setUp() {
        ...
        walkingPointList = Arrays.asList(classRoomInHBuildingWalkingPoint1, walkingPoint1, walkingPoint2, walkingPoint3, classRoomInHBuildingWalkingPoint2,
                entranceHBuildingWalkingPoint, elevatorWalkingPointH9,entranceMBBuildingWalkingPoint, walkingPoint4, classRoomInMBBuildingWalkingPoint);
    ...
    private void settingUpWalkingPoints(){
        ...
        walkingPoint5 = new WalkingPoint(12,new Coordinates(2, 3), "H-8", new ArrayList<>(Arrays.asList(new Integer[]{11,13})),PointType.NONE,"NONE");
    ...
    public void getEuclideanDistanceTest(){
        ...
        assertEquals(expectedValue, indoorPathHeuristic.getEuclideanDistance(classRoomInHBuildingWalkingPoint1, walkingPoint1));
    }

    @Test
    public void getClosestPointToCurrentPointFromListTest(){
        List<WalkingPoint> closestPoint = new ArrayList<>();
        closestPoint.add(walkingPoint1);
        closestPoint.add(walkingPoint3);
        assertEquals(walkingPoint3, indoorPathHeuristic.getClosestPointToCurrentPointFromList(classRoomInHBuildingWalkingPoint1,closestPoint));
    }
    ...
    public void computeHeuristicSameFloorTest(){
        ...
        assertEquals(expectedHeuristicValue,indoorPathHeuristic.computeHeuristic(classRoomInHBuildingWalkingPoint1, walkingPoint1));
    }
