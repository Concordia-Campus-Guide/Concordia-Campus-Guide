...
public class WalkingPointsTest {
    ...
    public void getWalkingPointsTest() {
        assertEquals(walkingPoints.getWalkingPointList(), walkingPointsList);
        assertEquals(new WalkingPoints().getWalkingPointList(), new ArrayList<WalkingPoint>());
    }
    @Test
    public void setWalkingPointsTest() {
        ...
        List<WalkingPoint> temp = walkingPoints.getWalkingPointList();
        walkingPoints.setWalkingPointList(walkingPointsListTemp);
        assertEquals(walkingPoints.getWalkingPointList(), walkingPointsListTemp);
        walkingPoints.setWalkingPointList(temp);
    }
}
