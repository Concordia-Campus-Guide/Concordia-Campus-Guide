...
public class DirectionStepsJson {
    ...
    public DirectionsResult readingJson() {
        ...
        try {
//            InputStream is = getClass().getResourceAsStream("app/src/test/res/");
            InputStream is = this.getClass().getClassLoader().getResourceAsStream("app/src/test/res/test_walking_points.json");
